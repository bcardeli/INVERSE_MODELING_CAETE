...
for gridcell in init_conditions:
    ...
    gridcell.tas += 3.2 #TEMPERATURE (ºC) - #RCP4.5: 3.2 / RCP7.0: 4.4 / RCP8.5: 5,5
    gridcell.pr -= gridcell.pr * 0.58 #PRECIPITATION (%) - #RCP4.5: 0.58 / RCP6.0: 0.129 / RCP8.0: 0.148
...
def apply_funX(grid, brk):
    grid.run_caete(brk[0], brk[1], fix_co2=600.0) #[CO2] (ppm) 
